...
const inputDistance = document.querySelector('.form__input--duration');
...
class App {
  ...
  _newWorkout(e) {
    ...
    const validInputs = (...inputs) =>
      inputs.every(inp => Number.isFinite(inp)); // check for input numbers
    const allPositive = (...inputs) => inputs.every(inp => inp > 0); // check for positive inputs
